...
class ConcreteExtModel(ExtModel):
    ...
    attr10 = models.BooleanField(max_length=255, verbose_name='测试属性10', null=True, blank=True, default=False)
    ...
    attr13 = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='测试属性13', null=True, blank=True)
    ...
    definition = models.ForeignKey(ModelDefinitionModel, on_delete=models.CASCADE, null=True, blank=True, verbose_name='模型定义')
