        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'scope',
                    models.CharField(
                        choices=[('STORE', 'STORE'), ('PARSING', 'PARSING')],
                        max_length=20,
                        verbose_name='插件作用域',
                    ),
                ),
                ...
                (
                    'status',
                    models.CharField(default='active', max_length=20, verbose_name='插件状态'),
                ),
                ...
                (
                    'tags',
                    models.CharField(
                        default='', help_text='逗号分隔', max_length=1000, verbose_name='插件标签'
                    ),
                ),
                (
                    'create_user',
